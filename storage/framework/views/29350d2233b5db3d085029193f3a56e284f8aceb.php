...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.property-modal','data' => ['realEstateObject' => $realEstateObject]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('property-modal'); ?>
...
<script type="text/javascript">
    ...
    var swiper = new Swiper("#swiper-<?php echo e($realEstateObject->id); ?>", {
        effect: "cube",
        grabCursor: true,
        ...
        pagination: {
            ...
            el: ".swiper-<?php echo e($realEstateObject->id); ?>-carousel-pagination"
        }
    });
...
<?php /**PATH /Users/hidekiyukawa/GETTING_THE_HANG/resources/views/components/property-show-layout.blade.php ENDPATH**/ ?>