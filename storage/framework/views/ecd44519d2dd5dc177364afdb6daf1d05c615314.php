...
<?php $component->withAttributes([]); ?>
    <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.modal','data' => ['listing' => $listing]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="mb-6">
          ...
          <textarea class="border border-gray-200 rounded p-2 w-full" name="description" rows="10"
            placeholder="Include tasks, requirements, salary, etc"><?php echo e($listing->description); ?>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="mb-6">
          <button class="bg-black text-white rounded-lg py-2 px-4 hover:bg-red">
            Edit
          </button>

          <a href="/listings/<?php echo e($listing->id); ?>"
             class="px-4 py-2 h-10 w-20 rounded-lg ml-4 hover:bg-red-500 hover:text-white">
               Back
          </a>
        </div>
      </form>
...
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?>
<?php /**PATH /Users/hidekiyukawa/GETTING_THE_HANG/resources/views/listings/edit.blade.php ENDPATH**/ ?>