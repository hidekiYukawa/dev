...
<?php $component->withAttributes([]); ?>
    <div class="flex">
        <img
            ...
            src="<?php echo e($listing->image ? asset(explode(',', $listing->image)[0]) : asset('images/no-image.png')); ?>"
            alt=""
        />
        <div>
            <h3 class="text-2xl">
...
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?>
<?php /**PATH /Users/hidekiyukawa/GETTING_THE_HANG/resources/views/components/listing-card.blade.php ENDPATH**/ ?>