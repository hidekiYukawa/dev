...
<html lang="en">
    ...
    <body class="mb-48">
        ...
        <div id="one" class="button absolute top-1/3 left-5 bg-black text-white py-2 px-5">Modal</div>
        <a href="/listings/create" class="absolute top-1/3 right-5 bg-black text-white py-2 px-5">Post Real Estate</a>
    </footer>
...
<?php /**PATH /Users/hidekiyukawa/GETTING_THE_HANG/resources/views/components/layout.blade.php ENDPATH**/ ?>